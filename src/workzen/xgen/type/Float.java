...
public class Float extends XGenType {

	public Float() {
		super.name = "Float";
		super.qualifiedName = "java.lang.Float";
		super.primitiveName = "float";
		super.primitiveFunction = "floatValue()";
		super.sqlType = "java.sql.Types.REAL";
	}
}
