...
public class Byte extends XGenType {

	public Byte() {
		super.name = "Byte";
		super.qualifiedName = "java.lang.Byte";
		super.primitiveName = "byte";
		super.primitiveFunction = "byteValue()";
		super.sqlType = "java.sql.Types.TINYINT";
	}
