...
public class Str extends XGenType {

	public Str() {
		super.name = "String";
		super.qualifiedName = "java.lang.String";
		super.primitiveName = "string"; // required
		super.primitiveFunction = "";
		super.sqlType = "java.sql.Types.VARCHAR";
	}
}
