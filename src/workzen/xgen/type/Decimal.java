...
public class Decimal extends XGenType {

	public Decimal() {
		super.name = "BigDecimal";
		super.qualifiedName = "java.math.BigDecimal";
		super.primitiveName = "double";
		super.primitiveFunction = "doubleValue()";
		super.sqlType = "java.sql.Types.DECIMAL";
	}
}
