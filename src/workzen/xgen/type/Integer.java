...
public class Integer extends XGenType {

	public Integer() {
		super.name = "Integer";
		super.qualifiedName = "java.lang.Integer";
		super.primitiveName = "int";
		super.primitiveFunction = "intValue()";
		super.sqlType = "java.sql.Types.INTEGER";
	}
