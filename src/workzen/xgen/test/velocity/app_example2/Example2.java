package workzen.xgen.test.velocity.app_example2;
...
public class Example2 {
	public static void main(String args[]) {
		...
		//String template = "example2.vm";
		String template = "/Project/workzen.xgen/src/workzen/xgen/test/velocity/app_example2/example2.vm";
