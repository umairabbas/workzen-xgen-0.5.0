package workzen.xgen.test.velocity.app_example1;
...
public class Example {
	...
	public static void main(String[] args) {
		...
		String template =	"/Project/workzen.xgen/src/workzen/xgen/test/velocity/app_example1/example.vm";
		Example t = new Example(template);
	}
}
